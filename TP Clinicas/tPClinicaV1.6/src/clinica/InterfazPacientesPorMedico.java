...
public class InterfazPacientesPorMedico extends JFrame {
	...
	public InterfazPacientesPorMedico() {
		...
		JComboBox comboBox_codMedicos = new JComboBox();
				...
				try {
					...
					while(line != null){
						...
						if(codigoPacienteArrayList== Integer.parseInt(datos[0])){
							...
							while(codigoPacienteArrayList==codPacientes.get(i)){
								i++;
							}
		...
		btnVerPaciente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				interfazVerPaciente.setearCodigoPaciente((String)comboBox.getSelectedItem());
				interfazVerPaciente.llenarCampos();
