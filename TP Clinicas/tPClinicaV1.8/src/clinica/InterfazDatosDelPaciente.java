...
public class InterfazDatosDelPaciente extends JFrame{
	...
	public InterfazDatosDelPaciente() {
		...
		//inicio de busqueda del ultimo codigo asignado
				...
				public void actionPerformed(ActionEvent e) {
					...
					else
					{
						if (texTipoDeSangre.getText().length()*texDni.getText().length()*texFechaDeIngreso.getText().length()*texNombre.getText().length()*texTelefono.getText().length()*texCalle.getText().length()*texNumero.getText().length() != 0) {
							...
							paciente = new Paciente(ultimoCod, texTipoDeSangre.getText(), Integer.parseInt(texDni.getText()), texFechaDeIngreso.getText(), texNombre.getText(), texTelefono.getText() , texCalle.getText() +" "+ texNumero.getText());
							
							FileWriter fichero = null;
					        PrintWriter pw = null;
					        try
					        {
					            fichero = new FileWriter("./bin\\Pacientes.txt", true); //Con pasarle por parametro el true agrega al final sin borrar el contenido
					            pw = new PrintWriter(fichero);
					            
					            pw.println(encriptar(paciente.toString()));
			...
			lblFechaDeIngreso = new JLabel("Fecha de Ingreso(dd-mm-aaaa)");
			...
			lblFechaDeIngreso.setBounds(10, 319, 287, 26);
			...
			lblTipoDeSangre = new JLabel("Tipo de Sangre (A+,A-,B+,B-,O-,O+)");
			...
			lblTipoDeSangre.setBounds(17, 282, 297, 26);
			...
			lblTelefono.setBounds(22, 245, 83, 26);
			...
			texFechaDeIngreso.setBounds(307, 323, 103, 20);
			...
			texTipoDeSangre.setBounds(327, 286, 83, 20);
			...
			texTelefono.setBounds(168, 249, 242, 20);
			...
			texNumero.setBounds(168, 419, 131, 20);
