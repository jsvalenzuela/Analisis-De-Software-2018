...
public class InterfazIngresoDeDatos extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6482253926711456302L;
	...
	public InterfazIngresoDeDatos() {
		...
		lblFondoIngresoDeDatos.setIcon(new ImageIcon(Login.class.getResource("borde2.png")));
		...
		btnDatosDelPaciente = new JButton("Registrar Paciente");
		...
		btnInformes = new JButton("Registrar cita");
		...
		btnDatosDelMedico = new JButton("Registrar Medico");
